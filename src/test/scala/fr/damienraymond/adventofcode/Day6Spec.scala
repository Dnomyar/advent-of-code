...
class Day6Spec extends AnyFlatSpec with Matchers {
  ...
  val vector0 = Vector.fill[Long](10)(0)
  ...
  it should "generate 26984457539 after 80d for the example given" in {
    Day6.part1("3,4,3,1,2")(256) should be(26984457539L)
  }
  ...
  it should "decrease the number days - 1" in {
    Day6.numberOrFishAfter2(1)(vector0.updated(5, 1L)) should be(vector0.updated(4, 1))
  }

  it should "decrease the number days - 2" in {
    Day6.numberOrFishAfter2(1)(vector0.updated(5, 1L).updated(4, 2L)) should be(
      vector0.updated(4, 1).updated(3, 2)
    )
  }

  it should "decrease the number days - 3" in {
    Day6.numberOrFishAfter2(1)(vector0.updated(5,4L).updated(4,6L).updated(3,8L)) should be(
      vector0.updated(4,4).updated(3,6).updated(2,8)
    )
  }

  it should "create a new fish after when it reaches 0" in {
    Day6.numberOrFishAfter2(1)(vector0.updated(0,1L)) should be(
      vector0.updated(6,1).updated(8,1)
    )
  }

  it should "repeat the simple operation for 2 days" in {
    Day6.numberOrFishAfter2(2)(vector0.updated(5,2L).updated(0,1L)) should be(
      vector0.updated(3,2).updated(7,1).updated(5,1)
    )
  }

  it should "keep every element" in {
    Day6.numberOrFishAfter2(1)(vector0.updated(7,1L).updated(0,1L)) should be(
